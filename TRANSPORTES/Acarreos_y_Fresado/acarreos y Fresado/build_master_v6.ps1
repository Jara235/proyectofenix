...
$wsResumen.Cells.Item(1, 7) = "Fresado por Día y Obra"
$wsResumen.Cells.Item(1, 12) = "Total Acarreos en Obra"
$wsResumen.Cells.Item(1, 2).Font.Bold = $true
$wsResumen.Cells.Item(1, 7).Font.Bold = $true
$wsResumen.Cells.Item(1, 12).Font.Bold = $true
...
$df1_1 = $pt1.AddDataField($pt1.PivotFields("FOLIO"), "Viajes", -4112) # xlCount
$df1_2 = $pt1.AddDataField($pt1.PivotFields("PU"), "Costo Surtido", -4157) # xlSum
...
$pt2 = $pc.CreatePivotTable("Dashboard_Ejecutivo!R4C7", "PT_Fresado")
...
# Pivot Table 3: TOTAL
$pt3 = $pc.CreatePivotTable("Dashboard_Ejecutivo!R4C12", "PT_Total")
...
# Set classic layout for PT to show row fields side by side instead of compact
$pt1.RowAxisLayout(1)
$pt2.RowAxisLayout(1)
$pt3.RowAxisLayout(1)
...
$wsResumen.Columns.Item(8).ColumnWidth = 15
$wsResumen.Columns.Item(9).ColumnWidth = 25
$wsResumen.Columns.Item(10).ColumnWidth = 15
$wsResumen.Columns.Item(12).ColumnWidth = 15
$wsResumen.Columns.Item(13).ColumnWidth = 25
